...
var $author$project$Main$initialModel = {name: '', playerId: $elm$core$Maybe$Nothing, players: _List_Nil, plays: _List_Nil};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var play = msg.a;
				return A2($author$project$Main$deletePlay, play, model);
		}
	});
...
var $author$project$Main$renderPlay = function (play) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$playList = function (model) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$renderPlay, model.plays));
};
...
var $author$project$Main$playerList = function (model) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$renderPlayer,
			A2(
